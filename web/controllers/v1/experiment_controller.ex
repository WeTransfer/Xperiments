defmodule Xperiments.V1.ExperimentController do
  ...
  def create(conn, %{"experiment" => experiment_data}) do
    ...
    case Repo.insert(changeset) do
      ...
      {:error, changeset} ->
        ...
        |> render(Xperiments.V1.ErrorView, "error.json", changeset: changeset)
    end
  end
  ...
  def variant(conn, %{"experiment_id" => e_id, "variant_id" => var_id}) do
    ...
    case Enum.find(exp.variants, &(&1.id == var_id)) do
      nil ->
        ...
        |> render(Xperiments.V1.ErrorView, "common_error.json", %{error: %{experiment: msg}})
      var ->
        render(conn, Xperiments.V1.VariantView, "show.json", variant: var)
    end
  end
  ...
  defp get_application(conn, _params) do
    ...
    case Repo.get_by(Application, name: app_name) do
      nil ->
        ...
        |> render(Xperiments.V1.ErrorView, "common_error.json", %{error: %{application: err_message}})
        |> halt()
      app ->
